...
"use strict";var t=a(require("lodash/throttle"));function a(e){return e&&e.__esModule?e:{default:e}}const o={},r="feedback-form-state",c={form:document.querySelector(".feedback-form"),input:document.querySelector(".feedback-form input"),textarea:document.querySelector(".feedback-form textarea")};function n({name:t,value:a}){o[e.target.name]=e.target.value,localStorage.setItem(r,JSON.stringify(formValues))}function l(e){e.preventDefault(),e.currentTarget.reset(),localStorage.removeItem("feedback-msg"),localStorage.removeItem("feedback-email")}function u(e){const t=e.target.value;localStorage.setItem("feedback-email",t)}function f(){const e=localStorage.getItem("feedback-email");e&&(console.log(e),c.input.value=e)}function m(e){const t=e.target.value;localStorage.setItem("feedback-msg",t)}function s(){const e=localStorage.getItem("feedback-msg");e&&(console.log(e),c.textarea.value=e)}c.form.addEventListener("submit",l),c.form.addEventListener("input",(0,t.default)(n,500)),s(),f();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.0d945ec9.js.map