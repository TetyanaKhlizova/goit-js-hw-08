...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a={form:document.querySelector(".feedback-form"),input:document.querySelector(".feedback-form input"),textarea:document.querySelector(".feedback-form textarea")};function o(e){e.preventDefault(),e.currentTarget.reset(),localStorage.removeItem("feedback-msg"),localStorage.removeItem("feedback-email")}function r(e){const t=e.target.value;localStorage.setItem("feedback-email",t)}function n(){const e=localStorage.getItem("feedback-email");e&&(console.log(e),a.input.value=e)}function c(e){const t=e.target.value;localStorage.setItem("feedback-msg",t)}function l(){const e=localStorage.getItem("feedback-msg");e&&(console.log(e),a.textarea.value=e)}a.form.addEventListener("submit",o),a.input.addEventListener("input",(0,e.default)(r,500)),a.textarea.addEventListener("input",(0,e.default)(c,500)),l(),n();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.2ff1e6a5.js.map