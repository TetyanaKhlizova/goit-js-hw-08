...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const o="videoplayer-current-time",r=localStorage.getItem(o),l=document.querySelector("iframe"),n=new Vimeo.Player(l);function i({seconds:e}){localStorage.setItem(o,e)}r&&n.setCurrentTime(r),n.getVideoTitle().then(function(e){console.log("title:",e)}),n.on("timeupdate",(0,e.default)(i,1e3));
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.3d02540c.js.map